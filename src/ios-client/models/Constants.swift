...
struct FeatureFlags {
    ...
    static let defaultBatchTargetCount = 100 // 
    static let defaultICloudPhotoCount = 1000 // Default number of photos to fetch from iCloud
    static let maxTargetPhotoSelection = 1000 // Maximum number of target photos that can be selected for batch comparison (increased for testing)
    ...
    static let enableDebugLogTimeSync = false // Debug: log time synchronization issues
    ...
    static let enableDebugLogAuth = false // Debug: log AuthService operations and token validation
    static let enableDebugLogUser = false // Debug: log user fetch/search operations
    static let enableDebugLogKeyboard = false // Debug: log keyboard events and timing
}
